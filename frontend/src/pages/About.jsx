  ...
  return (
    <div>
      ...
      <div className='flex flex-col md:flex-row mb-20'>
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex rounded-xl flex-col gap-5 text-[15px] hover:bg-black hover:text-white transition-all duration-300 text-gray-700 cursor-pointer'>
          <b>EFFICIENCY:</b>
        ...
        <div className='border px-10 md:px-10 py-8 sm:py-16 flex rounded-xl flex-col gap-5 text-[15px] hover:bg-black hover:text-white transition-all duration-300 text-gray-700 cursor-pointer'>
          <b>PERSONALIZATION:</b>
