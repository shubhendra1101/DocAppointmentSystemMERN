      ...
      <div className='flex items-center gap-4'>
        ...
        {location.pathname === '/' && (
          <button
            ...
            className='bg-black text-white px-8 py-3 rounded-full hover:bg-gray-700 hidden md:block'
          >
            Admin Panel
          </button>
        )}
        ...
        {token && userData ? (
          ...
          <button
            ...
            className='bg-primary text-white px-8 py-3 rounded-full hidden md:block hover:bg-blue-800'
          >
            Create Account
          </button>
        )}
